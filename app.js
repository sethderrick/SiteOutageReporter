...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var outages, siteInfo_1, filteredOutages, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    filteredOutages = outages
                        .filter(function (o) { return new Date(o.startedAt) >= new Date("2022-01-01T00:00:00.000Z") && siteInfo_1.devices.includes(o.deviceId); })
                        .map(function (o) { return (__assign(__assign({}, o), { deviceName: siteInfo_1.devices.find(function (d) { return d.id === o.deviceId; }).displayName })); });
                    return [4 /*yield*/, post("site-outages/norwich-pear-tree", filteredOutages)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
